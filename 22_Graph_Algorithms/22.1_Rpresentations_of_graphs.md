...
**$$\text{Adjacency list Adj of Graph}(G=(V,E)) = \left[ \left[v \mid (u,v) \in E \right]\right] \forall u  \in V $$**

i.e. for every vertex u   
**$Adj[u] = \left[v \mid (u,v) \in E  \right]$** 
...
where NIL can be any appropriate value , majorly 0 or $\infty$ are used 
